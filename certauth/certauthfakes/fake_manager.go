...
type FakeManager struct {
	AddStub        func(certauth.Provider)
	addMutex       sync.RWMutex
	addArgsForCall []struct {
		arg1 certauth.Provider
	}
	GetStub        func(string) (certauth.Provider, error)
...
func (fake *FakeManager) Add(arg1 certauth.Provider) {
	fake.addMutex.Lock()
...
var _ certauth.Manager = new(FakeManager)
